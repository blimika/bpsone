...
<head>
   ...
   <title>Sistem Terpadu BPS Provinsi NTB</title>
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">
        ...
        <li><a href="<?php echo $url; ?>/pegawai/">PEGAWAI</a></li>
        <li><a href="<?php echo $url; ?>/surat/">SURAT</a></li>
        <li><a href="<?php echo $url; ?>/agenda/">AGENDA</a></li>
		    <li><a href="<?php echo $url; ?>/kinerja/">KINERJA</a></li>
        <li><a href="<?php echo $url; ?>/master/">MASTER</a></li>
		    <li class="dropdown">
              <a href="<?php echo $url; ?>/users/" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">USERS (<?php echo $_SESSION['s_id']; ?>) <span class="caret"></span></a>
