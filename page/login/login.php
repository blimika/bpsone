...
<head>
    ...
    <title>Login Masuk Sistem Terpadu BPS Provinsi NTB (ntbsatu)</title>
    ...
    <?php
		...
		if (isset($_POST['submit'])) {
				...
				if ($cek>0) {
					...
					$_SESSION['s_no']=$r->user_no;
					$_SESSION['s_passwd_md5']=$pass_md5;
					$_SESSION['s_passwd_ori']=$pass_ori;
					$_SESSION['s_nama']=$r->user_nama;
					$_SESSION['s_level']=$r->user_level;
					$login_ku="sukses";
...
<?php
//echo 'admin jadi md5 (admin) : ' . gen_passwd('admin');
//tutup_db($con); ?>
</html>
