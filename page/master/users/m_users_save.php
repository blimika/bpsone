...
if ($_POST['submit_save']) {
	...
	$user_nama= strtoupper(strtolower($user_nama));
	...
	if ($cek>0) {
		...
		$sql_users_save=$conn -> query("insert into users(user_id,user_nama,user_email,user_passwd,user_dibuat_oleh,user_dibuat_waktu,user_status,user_level) values('$user_id','$user_nama','$user_email','$pass_md5','$created','$waktu_lokal','$user_status','$user_level')");
