...
?>
		...
		<form id="formAddDetilPegawai" name="formAddDetilPegawai" action="<?php echo $url.'/'.$page;?>/savepns/"  method="post" class="form-horizontal well" role="form">
		<fieldset>
		...
		<div class="form-group">
			<label for="pegawai_nip_lama" class="col-sm-3 control-label">NIP LAMA</label>
				...
				<div class="col-lg-4 col-sm-4">
					<div class="input-group margin-bottom-sm">
				<span class="input-group-addon"><i class="fa fa-tag fa-fw"></i></span>
					<input type="text" name="pegawai_nip_lama" class="form-control" placeholder="NIP Lama"  />
				 </div>
				</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="pegawai_tmt_cpns" class="col-sm-3 control-label">TMT CPNS</label>
				<div class="col-lg-3 col-sm-3" id="tgl_lahir">
					<div class="input-group margin-bottom-sm">
				<span class="input-group-addon"><i class="fa fa-tag fa-fw"></i></span>
					<input type="text" name="pegawai_tmt_cpns" id="pegawai_tmt_cpns" class="form-control" placeholder="YYYY-MM-DD" />
				 </div>
				</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="pegawai_tmt_pns" class="col-sm-3 control-label">TMT PNS</label>
				<div class="col-lg-3 col-sm-3" id="tgl_lahir">
					<div class="input-group margin-bottom-sm">
				<span class="input-group-addon"><i class="fa fa-tag fa-fw"></i></span>
					<input type="text" name="pegawai_tmt_pns" id="pegawai_tmt_pns" class="form-control" placeholder="YYYY-MM-DD" />
				 </div>
				</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="pegawai_tmt_jabatan" class="col-sm-3 control-label">TMT Jabatan</label>
				<div class="col-lg-3 col-sm-3" id="tgl_lahir">
					<div class="input-group margin-bottom-sm">
				<span class="input-group-addon"><i class="fa fa-tag fa-fw"></i></span>
					<input type="text" name="pegawai_tmt_jabatan" id="pegawai_tmt_jabatan" class="form-control" placeholder="YYYY-MM-DD" />
				 </div>
				</div>
		</div>
		<div class="form-group">
			<label for="pegawai_pendidikan" class="col-sm-3 control-label">Pendidikan</label>
				<div class="col-sm-3">
					<div class="input-group margin-bottom-sm">
						...
						for ($i=1;$i<=4;$i++)
							{
								echo '<option value="'.$i.'">'.$JenisPendidikan[$i].'</option>';
							}
						?>
						</select>
					</div>
