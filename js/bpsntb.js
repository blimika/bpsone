    ...
    $('#formAddPegawai').bootstrapValidator({
       ...
       feedbackIcons: {
        ...
        fields: {
			...
			pegawai_nama: {
                validators: {
                    ...
                    stringLength: {
                        min: 6,
                        max: 100,
                        message: 'minimal 6 huruf max 100 huruf'
                    }
                }
            },
			pegawai_nama_panggilan: {
                validators: {
                    ...
                    stringLength: {
                        min: 3,
                        max: 20,
                        message: 'minimal 3 huruf max 20 huruf'
                    }
                }
            },
			pegawai_agama: {
            ...
            validators: {
                notEmpty: {
                    message: 'Silakan pilih status perkawinan'
                      }
                  }
            },
